# Runbook — sdkwork-terminal deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-terminal-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-terminal/bundle`, loads the image, starts
